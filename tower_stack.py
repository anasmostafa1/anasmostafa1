...
class Stack:
    ...
    def pushToStack(self):
        global brickW, score
        point=pygame.mixer.Sound("assets/correct.mp3")
...
def gameOver():
    loop = True
    over=pygame.mixer.Sound("assets/game-over.mp3")
    over.play()
    font = pygame.font.Font("assets/LoveDays.ttf", 100)
...
def showScore():
    font = pygame.font.Font("assets/LoveDays.ttf", 60)
